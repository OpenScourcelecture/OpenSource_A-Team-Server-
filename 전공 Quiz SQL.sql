...
insert into quiz1 values(21, '21.  현재 디렉토리에 git저장소를 생성하고싶을 때 사용하는 명령어는?', '1. git clone', '2. git add', '3. git init', '4. git push', 3);
insert into quiz1 values(22, '22.  내가 연결하고있는 서버를 확인하고싶을 때 사용하는 명령어는?', '1.   git remote -v', '2. git remote origin', '3. git remote rm', '4. git remote show', 1);
