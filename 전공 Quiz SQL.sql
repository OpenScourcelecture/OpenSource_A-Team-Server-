...
insert into quiz1 values(11, 11, '11.  vim표준모드에서 명령어들 중 저장만을 하고 싶을 때 사용하는 명령어는?', '1. :q', '2. :q!', '3. :w', '4, 'wq!', '3');
insert into quiz1 values(12, 12, '12. 입력 모드에서 표준 모드로 넘어갈 때 사용하는 키는?', '1. enter', '2. Ctrl', '3. esc', '4. i', '3' );
insert into quiz1 values(13, 13, '13.  표준 모드에서 입력 모드로 넘어갈 때 사용하는 키는?', '1. enter', '2. Ctrl', '3. esc', '4. i', '4' );
insert into quiz1 values(14, 14, '14.  표준 모드에서 G키를 눌렀을 때 발생하는 일로 옳은 것은?', '1. 문서의 맨 마지막 행으로 이동', '2. 이전 문단으로 이동', '3. 위 행의 첫 글자로 이동', '4. 한 화면 위로 스크롤', '1');
insert into quiz1 values(15, 15, '15.  mkdir 명령어를 사용하여 test라는 이름의 디렉토리를 만들고자 할 때 옳바르게 사용한 것은?', '1. mkdir: test', '2. test.mkdir', '3. mkdir test', '4. mkdir.test', '3');
insert into quiz1 values(16, 16, '16.  원격 저장소의 내용을 로컬 저장소로 복사하고 싶을 때 사용하는 명령어는?', '1. git download', '2. git remote', '3. git clone', '4. git pass', '3' );
insert into quiz1 values (17, 17, '17.  import문을 사용하여  Scanner를 사용하고 싶을 때 올바르게 작성 한 것은?' '1. import Scanner;' '2. import java.util.Scanner;' '3. import(Scanner), '4.import.Scanner', '2');
insert into quiz1 values (18, 18, '18.  다음 연산자중 OR의 의미를 가지고 있는 것은?', '1. a!=b', '2. a&&b', '3. !a', '4. a||b', '4');
insert into quiz1 values (19, 19, '19.  vim에서 전환 할 수 있는 모드중 없는 것은?', '1. 표준모드', '2. 편집 모드' '3. 입력 모드', '4. 명령라인 모드', '2' );
insert into quiz1 values (20, 20, '20.  vim에서 파일을 강제 저장 후 종료하고싶을 때 사용하는 명령어는?', '1. :wq!', '2. :q!' '3. :e', '4.:w', '1' );
